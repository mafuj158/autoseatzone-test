...
const TermsAndConditions = () => {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosPublic.get("/terms-and-conditions");
        ...
        <div className="bg-white rounded-xl shadow-md p-6 sm:p-10">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: data?.terms_description
                ?.replace(/<h3>/g, '<h3 class="text-lg font-semibold text-red-600 mt-6">')
                .replace(/<p>/g, '<p class="text-base leading-relaxed text-gray-700">')
